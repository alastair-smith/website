...
const headerStyleTemplate = document.createElement('template')
headerStyleTemplate.innerHTML = `
  <style>
    header {
      align-items: center;
...
customElements.define('common-header', class extends HTMLElement {
  constructor (...args) {
    ...
    shadowRoot.appendChild(headerStyleTemplate.content.cloneNode(true))
