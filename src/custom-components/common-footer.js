...
export class ContactLI extends LitElement {
  constructor () {
    super()
...
customElements.define('contact-li', ContactLI)
...
export class CommonFooter extends LitElement {
  ...
  static get styles () {
    return css`
      ...
      #email:focus-within svg path, #email:hover svg path {
        fill: #e98c3f;
      }
    `
  }
    ...
    return html`
      <footer>
        ...
        <ul>
          ...
          `}
          ${this.twitterHandle && html`
            <contact-li
              id='twitter'
              service='twitter'
              contact='@${this.twitterHandle}'
